                    ...
                    <div className="w-full flex flex-col justify-center items-center gap-5">
                        ...
                        <div className="flex md:flex-row flex-col md:gap-0 gap-5 items-center justify-center w-full">
                            <div className="h-12 md:w-fit w-full">
                                <select value={props.category} onChange={(e) => nav(`/home/${e.target.value}`)} className="h-full w-full text-white bg-blue-800 px-5 py-2 focus:outline-1 focus:outline-blue-800 outline-1 outline-blue-800 hover:bg-white hover:text-blue-800 hover:outline-1 hover:outline-blue-800 duration-300 cursor-pointer">
