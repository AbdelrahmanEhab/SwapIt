    ...
    return (
        <>
            <div className="flex justify-center items-center grow select-none">
                <div className="flex flex-col justify-center items-center gap-5 lg:px-40 md:px-20 px-5 py-10 max-w-[1000px] w-full h-full font-light">
                    ...
                    <button className="bg-blue-800 text-white px-10 py-2 hover:bg-white hover:text-blue-800 hover:outline-1 hover:outline-blue-800 duration-200 font-bold cursor-pointer w-full" onClick={() => nav('/home')}>
                       Verify
                    </button>
