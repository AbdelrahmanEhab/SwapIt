        ...
        <>
            <div className="w-full h-fit flex justify-center items-center bg-cover py-25">
                <div className="max-w-[1240px] w-full flex flex-col justify-center items-center text-blue-800 mx-10 gap-5">
                    ...
                    <p className="lg:text-xl sm:text-[1rem] text-[0.8rem] text-center text-black font-medium">SwapIt connects students to exchange items, free up space, and find great deals—all within your campus community</p>
                    <Link to="/signup">
