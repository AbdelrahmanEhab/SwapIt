        ...
        <>
            <div className="w-full h-fit flex justify-center items-center bg-cover py-25">
                <div className="max-w-[1600px] w-full flex flex-col justify-center items-center text-blue-800 mx-10 gap-5">
                    ...
                    <h1 className="lg:text-5xl sm:text-4xl text-3xl text-center text-black">Torino's First Student-Exclusice Marketplace</h1>
                    ...
                    <a href="">
                        <div className="bg-blue-800 text-white px-10 py-3 hover:scale-105 hover:bg-white hover:text-blue-800 hover:outline-1 hover:outline-blue-800 duration-200 lg:text-2xl sm:text-xl text-[1.1rem] mt-2 font-bold">
